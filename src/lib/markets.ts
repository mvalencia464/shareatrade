export const MARKETS = [
  ...
  },
  {
    ...
    name: "Omaha",
    state: "NE",
    tagline: "Papillion, Bellevue, La Vista, and Council Bluffs",
  ...
  },
  {
    ...
    name: "Cincinnati",
    state: "OH",
    tagline: "Loveland, Mason, West Chester, and nearby towns",
    dataforseoLocation: "Cincinnati,Ohio,United States",
    licenseEnrichment: false as const,
    live: true,
    cityAliases: ["Cincinnati", "Loveland", "Mason", "West Chester"],
  },
  {
    slug: "tulsa",
    name: "Tulsa",
    state: "OK",
    tagline: "Broken Arrow and nearby towns",
    dataforseoLocation: "Tulsa,Oklahoma,United States",
    licenseEnrichment: false as const,
    live: true,
    cityAliases: ["Tulsa", "Broken Arrow"],
  },
  {
    slug: "detroit",
    name: "Detroit",
    state: "MI",
    tagline: "Novi, Livonia, Farmington Hills, and nearby towns",
